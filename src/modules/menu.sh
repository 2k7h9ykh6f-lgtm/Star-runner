...
show_help() {
  ...
  printf "  [E]        - Activate ship skill (has a cooldown)\n"
  ...
  printf "${COLOR_GREEN}SHIP SKILLS ([E] key - each ship is different):${COLOR_NEUTRAL}\n"
  printf "  Scout       - Speed Boost: brief burst of extra speed\n"
  printf "  Interceptor - Rapid Fire: faster lasers, higher fire rate\n"
  printf "  Frigate     - Shield: gain a one-hit protective shield\n"
  printf "  Cruiser     - Mega Bomb: clear all asteroids on screen\n"
  printf "  Battleship  - Invincible Burst: temporary invincibility\n"
  printf "  A cooldown (shown on the HUD) limits skill use; it pauses with the game.\n\n"
